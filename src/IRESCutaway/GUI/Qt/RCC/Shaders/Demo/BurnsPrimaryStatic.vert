...
void main(void)
{
        ...
        if ( isPrimary( ) )
        {
                ...
                if ( property_type == 1.0 )
                        cube.color    =  propertyColor ( static_properties[property_index], min_StaticProperty, max_StaticProperty);
                else
                        cube.color    =  propertyColor ( dynamic_properties, min_DynamicProperty, max_DynamicProperty);
